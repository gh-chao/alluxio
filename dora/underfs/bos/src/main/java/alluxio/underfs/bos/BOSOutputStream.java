 ...
 */
@NotThreadSafe
public final class BOSOutputStream extends OutputStream implements ContentHashable {
    ...
    public void close() throws IOException {
        ...
        try (BufferedInputStream in = new BufferedInputStream(new FileInputStream(mFile))) {
            ...
            mContentHash = mBosClient.putObject(mBucketName, mKey, in, objMeta).getETag();
        } catch (BceClientException e) {
            LOG.error("Failed to upload {}.", mKey);
            throw new IOException(e);
        } finally {
            // Delete the temporary file on the local machine if the BOS client completed the
